...
class FAQController: UITableViewController {
	...
	override func viewDidLoad() {
		...
		//
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Infor", style: UIBarButtonItemStyle.Plain, target: self, action: "CitizenTabController().menuButtonPressed:")
	...
	override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
		...
		let cell1 = tableView.dequeueReusableCellWithIdentifier("cellFAQ1") as! FAQTableViewCell
